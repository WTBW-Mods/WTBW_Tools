...
{
  public static final String TOOLTIP_PRE = WTBWTools.MODID + ".tooltip.swap_target_pre";
  public static final String TOOLTIP_NONE = WTBWTools.MODID + ".tooltip.swap_none";
  public static final String TOOLTIP_RANGE = WTBWTools.MODID + ".tooltip.swap_range";
  public static final String MESSAGE_TARGET_CHANGED = WTBWTools.MODID + ".text.swap_target_changed";


  public static CommonConfig config = CommonConfig.instance();
