...
public class ArmorMaterialExt implements IArmorMaterial
{
  ...
  public static final ArmorMaterialExt COBALT = new ArmorMaterialExt("cobalt", ItemTierExt.COBALT, 37, new int[]{4, 7, 9, 4}, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 4, 0.01f);
  public static final ArmorMaterialExt SHULKER = new ArmorMaterialExt("shulker", ItemTierExt.SHULKER, 69, new int[]{6, 9, 11, 6}, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 8, 0.1f);
