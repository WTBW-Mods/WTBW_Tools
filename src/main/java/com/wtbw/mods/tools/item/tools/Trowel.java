...
//
  ...
  private static class TrowelContext extends ItemUseContext
  {
    ...
    {
      super(context.getWorld(), context.getPlayer(), context.getHand(), context.getItem(), new BlockRayTraceResult(context.getHitVec(), context.getFace(), context.getPos(), context.getPlayer().isCrouching()));
      actualItem = toPlace;
    }
